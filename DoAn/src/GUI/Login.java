...
import GUI.View.NhanVien;
import GUI.View.QuanLy;
...
public class Login extends javax.swing.JFrame {
    ...
    ps.setString(2, new String(txtPass.getPassword())); // Get password from JPasswordField
    ...
    if (txtUserName.getText().isEmpty() || new String(txtPass.getPassword()).isEmpty()) {
        ...
        switch (chucVu) {
            ...
            case "Nhân viên":
                ...
                break;
            default:
                JOptionPane.showMessageDialog(this, "Không có user này trong hệ thống");
                break;
        }

        // Dispose the login form after successful login
        this.dispose();
    } else {
        JOptionPane.showMessageDialog(this, "Đăng nhập thất bại");
    }

    // Close ResultSet, PreparedStatement and Connection after use
    rs.close();
    ps.close();
    provider.close(); // Close connection
