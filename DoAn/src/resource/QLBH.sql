...
CREATE TABLE [NHAPKHO] (
  MANHAPKHO BIGINT PRIMARY KEY IDENTITY(1,1) NOT NULL,
  MASP BIGINT NOT NULL,
  SOLUONGNHAP INT NOT NULL,
  NGAYNHAP DATETIME2 NOT NULL,
  CONSTRAINT FK_NHAPKHO_SANPHAM FOREIGN KEY (MASP) REFERENCES [SANPHAM](MASP),
);

GO
CREATE TABLE [XUATKHO] (
  MAXUATKHO BIGINT PRIMARY KEY IDENTITY(1,1) NOT NULL,
  MASP BIGINT NOT NULL,
  SOLUONGXUAT INT NOT NULL,
  NGAYXUAT DATETIME2 NOT NULL,
  CONSTRAINT FK_XUATKHO_SANPHAM FOREIGN KEY (MASP) REFERENCES [SANPHAM](MASP),
);
GO
