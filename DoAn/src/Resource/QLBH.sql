...
CREATE TABLE [MUCDONHANG] (
  ...
  CONSTRAINT FK_MUCDONHANG_DONHANG FOREIGN KEY (MADONHANG) REFERENCES [DONHANG](MADONHANG) ON DELETE CASCADE,
...
CREATE TABLE [HOADON] (
  ...
  CONSTRAINT FK_HOADON_DONHANG FOREIGN KEY (MADONHANG) REFERENCES [DONHANG](MADONHANG) ON DELETE CASCADE,
